  ...
  demoShots: [
    {
      ...
      img: 'assets/shots/paper3/p3-copilot-cli-1.jpg',
...
// 论文定位：**GitHub Copilot CLI** —— 论文 L 层 47 个项目中 "GitHub 官方 terminal agent" 路线标杆，**386 releases + 1.0.78 latest** + "the same agentic harness as GitHub's Copilot coding agent"。
...
interface GitHubCopilotCLICore {
  ...
  // ...
      ...
      points: [
        '**GitHub Copilot CLI 的核心抽象是论文 L 层代表** —— **GitHub Copilot CLI** —— 论文 L 层 47 个项目中 "GitHub 官方 terminal agent" 路线标杆，**386 releases + 1.0.78 latest** + "the same agentic harness as GitHub's Copilot coding agent"。',
        '****同 agentic harness** — 同一份 Copilot backend，VSCode / JetBrains / CLI 三端共享。**',
        '****GitHub 账号 = 身份** — OAuth 一处，**不用新注册**。**',
...
pip install github copilot cli`,
  ...
  philosophy: {
    ...
    answer: '**GitHub Copilot CLI** —— 论文 L 层 47 个项目中 "GitHub 官方 terminal agent" 路线标杆，**386 releases + 1.0.78 latest** + "the same agentic harness as GitHub's Copilot coding agent"。',
    problemDiagnosis: [
